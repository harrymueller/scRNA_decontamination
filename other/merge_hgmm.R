...
library(Seurat)
library(Matrix)
source("/media/harry/Data/Perkins/develop/scripts/hgmm12k/get_data.R")

#input_dir = "/data/harry_decont_project/hgmm12k/data/CellRanger"
#output_dir = "/data/harry_decont_project/hgmm12k/data/CellRanger_merged2/raw_gene_bc_matrices"
input_dir = "/media/harry/Data/Perkins/Human_Mouse/data/CellRanger"
output_dir = "/media/harry/Data/Perkins/Human_Mouse/data/CellRanger_merged2"
